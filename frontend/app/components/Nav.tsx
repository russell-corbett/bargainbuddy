  ...
  return (
    <nav className="flex justify-between items-center p-4 bg-white border-b w-full">
      ...
      <div className="flex items-center space-x-4 md:space-x-8">
        ...
        >
          <div className="transition-all duration-300">
            {isGroceriesHovered ? <FontAwesomeIcon icon={faBasketShopping} /> : "Groceries"}
          </div>        
        </a>
        ...
        >
          <div className="transition-all duration-300">
            {isTechHovered ? <FontAwesomeIcon icon={faMicrochip} /> : "Technology"}
          </div>
        </a>
        <a
          href="/settings"
        ...
        {isSearchOpen && (
          ...
          <button
            ...
            onClick={() => {
              handleSearchToggle(); // Call the first function
        ...
        >
          ...
          <div className="transition-all duration-300">
            {isSearchButtonClicked ? "Search" : <FontAwesomeIcon icon={faMagnifyingGlass} />}
          </div>
        </button>
      </div>
    </nav>
